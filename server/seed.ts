...
export const Builder: Agent = {
    ...
    currentTaskId: 'build-foundation', checkpoint: 'inspect', changedFiles: [], logTail: [], lastUpdated: seedTimestamp
};
export const Tester: Agent = {
    id: 'tester', name: 'Tester', role: 'tester', status: 'working', zone: 'desk', x: 5, y: 2,
    currentTaskId: 'test-foundation', checkpoint: 'inspect', changedFiles: [], logTail: [], lastUpdated: seedTimestamp
};
export const Documenter: Agent = {
    id: 'documenter', name: 'Documenter', role: 'documenter', status: 'working', zone: 'desk', x: 8, y: 2,
    currentTaskId: 'document-foundation', checkpoint: 'inspect', changedFiles: [], logTail: [], lastUpdated: seedTimestamp
};
